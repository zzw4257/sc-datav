...
// Remove Store dependency or make it optional/prop based
// For simplicity in this generic component, we'll assume bar is visible or controlled by prop
